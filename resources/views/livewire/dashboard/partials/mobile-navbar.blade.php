    ...
    <div class="flex justify-between items-center md:justify-around">
            ...
            <div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        stroke-width="{{ request()->is('dashboard/robot') || request()->is('dashboard/robot/traderoom') ? 2 : 1 }}"
                        stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bot-icon lucide-bot">
                        <path d="M12 8V4H8" />
        ...
        <a class="block" href="{{ route('dashboard.support') }}">
            <div>
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="#D4D4D4" stroke-width="{{ request()->is('dashboard/support') ? 2 : 1 }}" stroke-linecap="round" stroke-linejoin="round"
