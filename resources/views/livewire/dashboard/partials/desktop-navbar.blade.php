<div class="hidden lg:flex flex-none flex-col items-center space-y-4 w-18 lg:border-r-[0.1px] lg:border-gray-700">
    <div @class([
        'bg-accent' => request()->is('dashboard'),
        'w-full' => true,
        'py-3' => true,
        'cursor-pointer' => true,
    ...
    <div @class([
        'bg-accent' => request()->is('dashboard/history'),
        'w-full' => true,
        'py-3' => true,
        'cursor-pointer' => true,
        'hover:bg-accent' => true,
    ...
    <div @class([
        'bg-accent' =>
            request()->is('dashboard/robot') ||
            request()->is('dashboard/robot/traderoom'),
        'w-full' => true,
        'py-3' => true,
        'cursor-pointer' => true,
        'hover:bg-accent' => true,
    ...
    <div @class([
        'bg-accent' => request()->is('dashboard/support'),
        'w-full' => true,
        'py-3' => true,
        'cursor-pointer' => true,
        'hover:bg-accent' => true,
        ...
        <a class="block" href="{{ route('dashboard.support') }}">
            ...
            <div class="text-center">
                <p @class([
                    ...
                    'text-[10px]' => true,
                    'text-zinc-300' => true,
                ]) class="font-normal">Support</p>
            </div>
        </a>
    </div>

    <div @class([
        'bg-accent' => request()->is('dashboard/account'),
        'w-full' => true,
        'py-3' => true,
        'cursor-pointer' => true,
        'hover:bg-accent' => true,
