                                                ...
                                                <div class="flex items-center justify-center">
                                                    <div class="relative">
                                                        ...
                                                        <div x-show="isActionDropdownOpen"
                                                            ...
                                                            class="shadow-theme-lg dark:bg-gray-dark absolute z-10 w-fit-content space-y-1 rounded-2xl border border-gray-200 bg-white p-2 pr-4 dark:border-gray-800">
                                                            <form
