<div>
    ...
    <div class="mx-auto px-4">
        ...
        <div>
            <div
                class="flex group items-center space-x-3 mx-auto rounded-sm bg-white border border-accent p-1.5 mb-3 w-48 text-sm font-medium shadow-xs hover:bg-accent">
                <div>
                ...
                <div>
                    <p class="text-zinc-700 group-hover:text-white font-semibold">For Mobile</p>
                    <p class="text-gray-400 group-hover:text-white text-[11px]">.apk 21.5 Mb</p>
                </div>
            </div>

            <div
                class="flex group items-center space-x-3 mx-auto rounded-sm bg-white border border-accent p-1.5 w-48 text-sm font-medium shadow-xs hover:bg-accent">
                <div>
                ...
                <div>
                    <p class="text-zinc-700 font-semibold group-hover:text-white">Open in Browser</p>
                    <p class="text-gray-400 text-[11px] group-hover:text-white">Web Platform</p>
                </div>
            </div>
        </div>
    </div>
