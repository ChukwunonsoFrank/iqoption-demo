<div class="hidden lg:flex flex-none flex-col items-center space-y-4 w-18 lg:border-r-[0.1px] lg:border-gray-700">
    <div @class(['bg-accent' => request()->is('dashboard'), 'w-full' => true, 'py-3' => true, 'cursor-pointer' => true, 'hover:bg-accent' => true])>
    ...
    <div @class(['bg-accent' => request()->is('dashboard/history'), 'w-full' => true, 'py-3' => true, 'cursor-pointer' => true, 'hover:bg-accent' => true])>
    ...
    <div @class(['bg-accent' => request()->is('dashboard/robot') || request()->is('dashboard/robot/traderoom'), 'w-full' => true, 'py-3' => true, 'cursor-pointer' => true, 'hover:bg-accent' => true])>
        <a class="block" wire:click="robot()">
            <div class="mb-1">
                <svg class="block mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24" fill="none" stroke="#D4D4D4" stroke-width="2" stroke-linecap="round"
    ...
    <div class="w-full py-3 cursor-pointer hover:bg-accent focus:bg-accent">
        <div class="mb-1">
            <svg class="block mx-auto" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                viewBox="0 0 24 24" fill="none" stroke="#D4D4D4" stroke-width="2" stroke-linecap="round"
        ...
        <div class="text-center">
            <p class="text-[10px] text-zinc-300 font-bold">Support</p>
        </div>
    </div>

    <div @class(['bg-accent' => request()->is('dashboard/account'), 'w-full' => true, 'py-3' => true, 'cursor-pointer' => true, 'hover:bg-accent' => true])>
